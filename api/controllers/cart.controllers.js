...
const getUserCart = (req, res) => {
  try {
    ...
    console.error(
      "file :: cart.controllers.js :: getUserCart :: error ::",
      error
    );
...
const addToUserCart = (req, res) => {
  try {
    ...
    console.error(
      "file :: cart.controllers.js :: addToUserCart :: error ::",
      error
    );
    return response.errorResponse(res, error);
  }
...
const updateUserCart = (req, res) => {
  try {
    ...
    console.error(
      "file :: cart.controllers.js :: updateUserCart :: error ::",
      error
    );
    return response.errorResponse(res, error);
  }
...
const deleteUserCart = (req, res) => {
  try {
    ...
    console.error(
      "file :: cart.controllers.js :: deleteUserCart :: error ::",
      error
    );
    return response.errorResponse(res, error);
  }
...
const deleteItemCart = (req, res) => {
  try {
    ...
    console.error(
      "file :: cart.controllers.js :: deleteItemCart :: error ::",
      error
    );
    return response.errorResponse(res, error);
  }
